...
$query1 = mysqli_query($con,"select * from category where cid=$ctshow");
...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <?php
        $category_id = $row['cid'];
        $product_result = mysqli_query($con,"SELECT * FROM products where category=$category_id");
